/* ============================================================
   AUDIO ENGINE — Sound Effects + Markov Chain Music
   ============================================================

   CS109 Concept: Conditional Probability / Markov Chains

   The background music is generated by a Markov chain over a
   pentatonic scale. Each note's successor is sampled from a
   transition matrix P(next | current). Two matrices define
   "calm" and "tense" moods — the game blends between them
   based on the Shannon entropy of the belief distribution.

   Lower entropy (more certain) → calmer, consonant music
   Higher entropy (more uncertain) → tenser, dissonant music
   ============================================================ */

// Pentatonic scale frequencies (Hz): C4, D4, E4, G4, A4, C5, D5
